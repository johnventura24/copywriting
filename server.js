...
app.post('/api/generate-variations', async (req, res) => {
    try {
        ...
        const copyFormatSpecs = {
            ...
            'search-ads': 'Search Ads Format - Create search engine advertising copy optimized for keyword relevance and user intent. Include compelling headlines (30 chars max), descriptions (90 chars max), and strong calls-to-action. Focus on matching search intent and including relevant keywords naturally.',
            'display-ads': 'Display Ads Format - Create visual advertising copy for banner ads, sidebar ads, and display networks. Write attention-grabbing headlines, compelling body text, and clear calls-to-action. Consider visual hierarchy and limited space. Focus on interrupting browsing behavior and creating interest.'
        };
        ...
        if (copyFormatSpec) {
            ...
            if (copyFormat === 'search-ads') {
                systemPrompt += `\n\nFORMAT EACH VARIATION AS:\nHeadline 1 (30 characters max):\n[text]\n\nHeadline 2 (30 characters max):\n[text]\n\nDescription 1 (90 characters max):\n[text]\n\nDescription 2 (90 characters max):\n[text]\n\nDisplay URL:\n[relevant domain/path]\n\nKeywords to target: [relevant keywords]`;
            }
            
            if (copyFormat === 'display-ads') {
                systemPrompt += `\n\nFORMAT EACH VARIATION AS:\nMain Headline (25-30 characters recommended):\n[text]\n\nSubheadline (40-50 characters recommended):\n[text]\n\nBody Text (50-75 characters recommended):\n[text]\n\nCall-to-Action Button (10-15 characters):\n[text]\n\nAd Size Consideration: [300x250, 728x90, 160x600, etc.]`;
            }
        }
